...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [self.galleryDataSource galleryView:self imageAndTextForIndex:indexPath.row completion:^(UIImage *image, NSString *text) {
        ...
        cell.image = [imageResizing imageWithImage:image scaledToWidth:self.bounds.size.width - 30.0];
        cell.text = text;
