...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [self.imageScrollView addGestureRecognizer:swipeGestureRecognizer];
...
{
    id<HacGalleryScrollViewDelegate> strongDelegate = self.delegate;
    NSLog(@"Taped\n");
    if ([(id)strongDelegate respondsToSelector:@selector(shouldReturn)]) {
        NSLog(@"Taped\n");
        [strongDelegate shouldReturn];
    }
}
