...
- (void)viewDidLoad {
    ...
    scrollView = [[HacGalleryScrollView alloc] initWithFrame:CGRectMake(3.5, 0, widthOfScreen, heightOfScreen)];
    //scrollView = [[HacGalleryScrollView alloc] initWithFrame:[[UIScreen mainScreen]bounds]];
    scrollView.widthOfColumnInScrollView           =175;
...
{
    NSURL *url = [NSURL URLWithString:@"http://10.116.3.119:3000/keywords/computer.json"];
